...
const caseStudyData: Record<string, CaseStudyData> = {
  "merchant-financial": {
    ...
    testimonial: {
      quote:
        "I was getting killed by brokers who make promises they can't keep. I operate with ethics, but that meant my team was cold calling all day with terrible results. My best guy was ready to quit. RevSquared built me an AI that scales my ethics - it qualifies prospects the way I would, but does it 20,000 times a day instead of 5,000. Now my team only calls people who already want funding and qualify for it. One funded deal paid for the whole system. It's been a game-changer.",
      author: "Jack",
    ...
    timeline: [
      {
        ...
        description:
          "Analyzed lending criteria, integrated with business records database",
      },
      {
        week: 2,
        milestone: "AI Training & Qualification Logic",
        description:
          "Trained AI on A-paper lending standards and ethical qualification processes",
      },
      {
        week: 3,
        milestone: "Volume Testing & Optimization",
        description:
          "Tested 20,000 daily contact capacity and conversation optimization",
      },
      {
        week: 4,
        milestone: "Launch & Team Training",
        description:
          "Full deployment with team training on qualified lead handling",
      },
    ],
  },
  "c4kr-real-estate": {
    ...
    solution:
      "We built Jason a complete AI ecosystem that thinks like him - mathematical, systematic, and focused on qualified opportunities only. The AI instantly engages and qualifies motivated sellers, handles inbound calls with full real estate knowledge, and automatically prioritizes highest-probability deals.",
    implementation: [
    ...
    testimonial: {
      quote:
        "I built my business on math - every call has a dollar value. But I was wasting 85% of my time calling people who'd never sell. RevSquared built me an AI that thinks like me but works 24/7. Now I only talk to motivated sellers who are qualified and ready. My close rate went from 15% to 67%. One deal pays for the system twice over. I finally work ON my business instead of IN it.",
    ...
    timeline: [
      {
        ...
        description:
          "Analyzed successful deals and mapped qualification criteria",
      },
      {
        week: 2,
        milestone: "AI Training & Real Estate Logic",
        description:
          "Trained AI on property assessment, motivation detection, and investment criteria",
      },
      {
        week: 3,
        milestone: "Integration & Lead Scoring",
        description:
          "Integrated CRM and implemented mathematical lead prioritization system",
      },
      {
        week: 4,
        milestone: "Launch & Optimization",
        description:
          "Go-live with performance tracking and deal flow optimization",
      },
    ],
  },
  "radiant-security": {
    ...
    timeline: [
      {
        ...
        description:
          "Analyzed DFY vs DIY operations and planned complex system architecture",
      },
      {
        week: 2,
        milestone: "Dual AI Development & Training",
        description:
          "Built separate Sales and Support AIs with complete security system knowledge",
      },
      {
        week: 3,
        milestone: "Complex Testing & Optimization",
        description:
          "Tested geographic logic, equipment recommendations, and technical troubleshooting",
      },
      {
        week: 4,
        milestone: "Launch & Cost Optimization",
        description:
          "Full deployment replacing expensive human labor with intelligent automation",
      },
    ],
  },
  "bana-roofing": {
    ...
    challenge:
      "Don built BANA Roofing into a 7-figure business through quality work and stellar reviews. His SEO was crushing it, ads had high ROAS, but success was strangling his growth. Every lead that made him money was creating two problems: phone chaos with constantly ringing qualified leads, response delays taking days to reach hot prospects, and feeding competition through slow follow-up.",
    solution:
      "We built Don a complete AI ecosystem that captures leads from every possible touchpoint and converts them while he focuses on scaling. Complete AI coverage includes SMS AI, Voice AI, Website Chat AI, and Facebook Messenger AI - all feeding into a single qualification pipeline with roofing & solar intelligence.",
    implementation: [
    ...
    testimonial: {
      quote:
        "I was drowning in my own success. My phone never stopped ringing, but I was losing deals because I couldn't get back to people fast enough. I was feeding my competition while working 16-hour days. RevSquared built me AI for every channel - SMS, voice, website, Facebook - everything. Now I respond to leads in seconds instead of days. I hired 5 more sales reps just to handle all the appointments the AI books. I'm finally scaling to 8-figures because I can actually handle the volume. Best part? I can sleep again.",
      author: "Don",
    ...
    timeline: [
      ...
      },
      {
        ...
        description:
          "Built AI for SMS, voice, website chat, and social media with roofing expertise",
      },
      {
        week: 3,
        milestone: "Unified Pipeline Testing",
        description:
          "Tested cross-channel lead capture and single qualification system",
      },
      {
        week: 4,
        milestone: "Scale-Ready Launch",
        description:
          "Deployed omnichannel system enabling unlimited growth capacity",
      },
    ],
  },
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                How {caseStudy.clientName} transformed their business with
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary mb-2">
                    +{caseStudy.results.leadIncrease}
                  </div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-accent mb-2">
                    {caseStudy.results.revenueImpact}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Revenue Impact
                  </div>
              ...
              <div className="bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/20 rounded-2xl p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Continue exploring our client transformations
                  </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 items-center">
                      <div>
                        ...
                        <p className="text-muted-foreground mb-4 line-clamp-2">
                          How {nextCaseStudy.clientName} transformed their
                          business with custom AI automation
                        </p>
                        ...
                        <div className="flex items-center gap-4 text-sm">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-semibold text-primary">
                              +{nextCaseStudy.results.leadIncrease}
                            </span>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-semibold text-accent">
                              {nextCaseStudy.results.revenueImpact}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg p-6 text-center">
                        ...
                        <div className="text-sm text-muted-foreground">
                          {nextCaseStudy.testimonial.title}
                        </div>
